<template>
  <section class="form-sec">
    ...
    <div class="form-submit">
      <van-button :loading="false" class="sign_btn" type="info" text="立即注册" loading-text="登录中..." />
    </div>
    <van-button class="helper-item left" @click="onUseComponent('sign')" text="返回登录"></van-button>
    <van-button class="helper-item right" @click="onUseComponent('email')" text="邮箱注册"></van-button>
  </section>
</template>
<script lang="ts">
